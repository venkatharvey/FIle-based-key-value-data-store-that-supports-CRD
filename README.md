 This is a file-based key-value data store that supports the basic CRD (crcate, read, and delete) operations. This data store is meant to be used as a local storage for one single process on one laptop.
